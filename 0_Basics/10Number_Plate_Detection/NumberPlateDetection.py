...
NumberPlaceCascade = cv2.CascadeClassifier("../haarcascades/haarcascade_russian_plate_number.xml")
...
while True:
    ...
    if ret:
        ...
        number_plate = NumberPlaceCascade.detectMultiScale(frame_gray, 1.1, 10)
